...
export function getAvailableCurrencies(): { code: string; name: string; rate: number }[] {
  return [
    ...
    { code: 'THB', name: 'Thai Baht', rate: exchangeRates['THB'] },
    { code: 'VND', name: 'Vietnamese Dong', rate: exchangeRates['VND'] },
    { code: 'MYR', name: 'Malaysian Ringgit', rate: exchangeRates['MYR'] },
    { code: 'IDR', name: 'Indonesian Rupiah', rate: exchangeRates['IDR'] },
    { code: 'KRW', name: 'South Korean Won', rate: exchangeRates['KRW'] },
    { code: 'TWD', name: 'Taiwan Dollar', rate: exchangeRates['TWD'] },
    { code: 'BDT', name: 'Bangladeshi Taka', rate: exchangeRates['BDT'] },
    { code: 'HKD', name: 'Hong Kong Dollar', rate: exchangeRates['HKD'] },
    { code: 'PHP', name: 'Philippine Peso', rate: exchangeRates['PHP'] },
    { code: 'SAR', name: 'Saudi Riyal', rate: exchangeRates['SAR'] },
    { code: 'QAR', name: 'Qatari Riyal', rate: exchangeRates['QAR'] },
    { code: 'KWD', name: 'Kuwaiti Dinar', rate: exchangeRates['KWD'] },
    { code: 'OMR', name: 'Omani Rial', rate: exchangeRates['OMR'] },
    { code: 'BHD', name: 'Bahraini Dinar', rate: exchangeRates['BHD'] },
    { code: 'TRY', name: 'Turkish Lira', rate: exchangeRates['TRY'] },
    { code: 'ZAR', name: 'South African Rand', rate: exchangeRates['ZAR'] },
    { code: 'AUD', name: 'Australian Dollar', rate: exchangeRates['AUD'] },
    { code: 'NZD', name: 'New Zealand Dollar', rate: exchangeRates['NZD'] },
    { code: 'CAD', name: 'Canadian Dollar', rate: exchangeRates['CAD'] },
    { code: 'CHF', name: 'Swiss Franc', rate: exchangeRates['CHF'] },
  ];
}
