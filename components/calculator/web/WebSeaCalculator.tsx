...
import WebSeaStepFreight from './WebSeaStepFreight';
...
const STEPS = ['Route', 'Products', 'Freight', 'Delivery'];
...
export default function WebSeaCalculator({
  ...
  return (
    <div className="min-h-screen lg:h-screen flex flex-col bg-[#FAFAFA] lg:overflow-hidden">
      ...
      <main className="flex-1 px-3 lg:px-4 py-3 max-w-7xl mx-auto w-full min-h-0">
        <button
          onClick={() => router.push('/')}
        ...
        <div className="flex flex-col lg:flex-row gap-5 lg:h-[calc(100vh-8rem)]">
          <div className="w-full lg:w-[55%] flex flex-col min-h-0">
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 lg:p-5 flex flex-col flex-1 min-h-0">
              <div className="mb-4">
                <h2 className="text-lg font-bold text-brand-brown mb-0.5">Sea Freight Calculator</h2>
