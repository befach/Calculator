...
import { MapPin, Weight, Box, Ruler, Download, ChevronDown, Package, Truck, Ship, Container } from 'lucide-react';
...
const exampleResult: SeaFreightResult = {
  originCountry: 'China',
  destinationSeaPort: 'JNPT',
  ...
  totalCbm: 25,
  containerUtilizationPercent: 32.9,
  weightUtilizationPercent: 18.9,
  oceanFreight: 135590,
  thcOrigin: 12713,
  thcDestination: 12000,
  blFee: 3500,
  doCharges: 3500,
  cfsCharges: 0,
  customExamination: 2000,
  demurrage: 0,
  detention: 0,
  totalFreightAndCharges: 169303,
  totalFobINR: 831200,
  totalInsurance: 5003,
  totalCifValue: 1005506,
  totalDuties: 311706,
  clearanceCharges: 5500,
  inlandTransport: 0,
  totalAdditionalCharges: 5500,
  totalLandedCost: 1322712,
  totalQuantity: 500,
  totalLandedCostForeign: 15913,
  fobPercent: 62.8,
  freightPercent: 13.2,
  dutiesPercent: 23.6,
  additionalPercent: 0.4,
  isUserFreight: false,
  ...
  products: [{
    ...
    grossWeight: 5000,
    cbm: 25,
    fobValueOriginal: 10000,
    fobValueINR: 831200,
    freightShare: 169303,
    insurance: 5003,
    cifValue: 1005506,
    bcdRate: 10,
    basicCustomsDuty: 100551,
    socialWelfareSurcharge: 10055,
    igstRate: 18,
    igst: 201100,
    totalDuties: 311706,
    clearanceShare: 5500,
...
export default function WebSeaResultsPanel({ result, isCalculating, currency, exchangeRate }: Props) {
      ...
      >
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <InfoCard
            icon={Weight}
            label="Gross Weight"
            value={`${data.totalGrossWeight} kg`}
          />
          <InfoCard
